...
@section('page_header')
    ...
    <h1 class="page-title">
        ...
        {{$name = __('voyager::generic.'.(!is_null($dataTypeContent->getKey()) ? 'edit' : 'add')).' '.$dataType->display_name_singular }}
    </h1>
    ...
    <div class="page-content edit-add container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                @if(\Request::is('admin/restaurant-menus/create'))
                    <h4>Rules</h4>
                    @foreach($rules as $k => $val)
                        @foreach($val as $key=> $value )
                            <p style="color:red">For {{$value}} category choose {{$key}} from restaurant_menus. </p>
                        @endforeach
                    @endforeach
                @endif
